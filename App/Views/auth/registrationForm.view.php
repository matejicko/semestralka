        ...
        <form name="loginForm" method="post" action="?c=auth&a=registration">
            <div class="mb-3">
                ...
                <input name="username" type="text" class="form-control"
                       id="nickname_input" aria-describedby="nickname_help" required>
            ...
            <div class="mb-3">
                ...
                <input name="name" type="text" class="form-control" id="name_input"
                       aria-describedby="name_help" required>
            ...
            <div class="mb-3">
                ...
                <input name="surname" type="text" class="form-control" id="surname_input"
                       aria-describedby="surname_help" required>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password_verify_input"
                       aria-describedby="password_verify_help" required>
...
<script src="public/scripts/passwordDoubleChecker.js"></script>
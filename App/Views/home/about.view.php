...
<div id="slide-show" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="public/images/meals/wiener-schnitzel.jpg" alt="Wiener Schnitzel" class="d-block w-100">
        ...
        <div class="carousel-item">
            <img src="public/images/meals/tulumba.jpg" alt="Tulumba" class="d-block w-100">
            <div class="carousel-caption">
                <div class="caption-box">
        ...
        <div class="carousel-item">
            <img src="public/images/meals/ful-mudames.jpg" alt="Ful Medames" class="d-block w-100">
            <div class="carousel-caption">
                <div class="caption-box">
                    <h3>(Južný) Sudán</h3>
                    <p>Ful Medames</p>

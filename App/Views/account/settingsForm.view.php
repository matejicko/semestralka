    ...
    <div class="row">
        ...
        <div class="col-sm-8 block">
            ...
            <?php if ($data['photo'] != null || $data['photo'] != ''){?>
                <img class="card-img-top img-fluid" src="<?=$data['photo']?>" alt="Profilová fotka" style="float: top; max-width: 20%"><br>
                <hr/>
                <?php }?>
                ...
                <div class="mb-3">
                    ...
                    <input name="username" type="text" class="form-control" id="nickname_input"
                           aria-describedby="nickname_help" value="<?=$data['username']?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="mail" type="text" class="form-control" id="email_input"
                           aria-describedby="email_help" value="<?=$data['mail']?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="name" type="text" class="form-control" id="name_input"
                           aria-describedby="name_help" value="<?=$data['name']?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="surname" type="text" class="form-control" id="surname_input"
                           aria-describedby="surname_help" value="<?=$data['surname']?>">
